...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo 'public/dist/bootswatch/' . (empty($this->config->item('theme')) ? 'flatly' : $this->config->item('theme')) . '/bootstrap.min.css' ?>"/>
	...
	<?php if ($this->input->cookie('debug') == 'true' || $this->input->get('debug') == 'true') : ?>
		...
		<link rel="stylesheet" href="public/bower_components/bootstrap-table/dist/extensions/sticky-header/bootstrap-table-sticky-header.css" />
		...
		<link rel="stylesheet" href="public/bower_components/bootstrap-tagsinput/dist/bootstrap-tagsinput.css" />
		<!-- endbower -->
		...
		<script src="public/bower_components/jquery-form/src/jquery.form.js"></script>
		...
		<script src="public/bower_components/bootstrap-table/dist/extensions/sticky-header/bootstrap-table-sticky-header.js"></script>
		...
		<script src="public/bower_components/chartist-plugin-barlabels/dist/chartist-plugin-barlabels.min.js"></script>
		...
		<script src="public/bower_components/bootstrap-tagsinput/dist/bootstrap-tagsinput.js"></script>
		<!-- endbower -->
	...
	<?php else : ?>
		...
		<link rel="stylesheet" type="text/css" href="public/dist/opensourcepos.min.css?rel=84371241b2"/>
		<!-- end mincss template tags -->
		<!-- start minjs template tags -->
		<script type="text/javascript" src="public/dist/opensourcepos.min.js?rel=d7a51432ab"></script>
			...
			<div class="container">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						<?php 
							//echo 'ddd:<pre>';print_r($allowed_modules);die;
						foreach($allowed_modules as $module): ?>
							<li class="<?php echo $module->module_id == $this->uri->segment(1) ? 'active' : ''; ?>">
								<a href="<?php echo site_url("$module->module_id"); ?>" title="<?php echo $this->lang->line("module_" . $module->module_id); ?>" class="menu-icon">
									<img src="<?php echo base_url() . 'public/images/menubar/' . $module->module_id . '.png'; ?>" border="0" alt="Module Icon"/><br/>
