...
*/
$config['composer_autoload'] = realpath(APPPATH . 'config/autoload.php');
...
|
*/
$config['encryption_key'] = getenv('ENCRYPTION_KEY') ? getenv('ENCRYPTION_KEY') : 'be37072e754baab339291d8465f535af7d9e589299e3fdf33690a8cb3d2c0e6e';
